...
public class Day4RunnerLab {
	public static void main(String[] args) throws Exception {
		Day4RunnerLab programRunner = new Day4RunnerLab();
...
/*
	public void runCarProgramExtension1() throws Exception {
		System.out.println("Welcome to the car program!");
...
*/
	...
	public void runCarProgramExtension2() throws Exception {
		...
		while (keepPlaying) {
			...
			keepPlaying = chooseCarOption(myCars, carChoice);
		}
	}

	public Boolean chooseCarOption(Car[] myCars, int carChoice) throws Exception { 
		while (true) {
				System.out.println("What would you like to do?");
				System.out.println(" (1) Start the car");
				System.out.println(" (2) Stop the car");
				...
				if (userChoice == 1) {
					try {
						...
						// System.out.println("You can't start a car that is already started!");
